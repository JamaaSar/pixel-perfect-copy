...
const Contact = () => {
  ...
  const handleRequestSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast({
      ...
      description: "Thank you for your inquiry. We will review and respond where appropriate."
    });
  ...
  const handleWhistleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast({
      ...
      description: "Your report has been received and will be reviewed with discretion."
    });
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              engagements, partnerships, and general professional matters.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          >
            <div className="bg-card p-8 lg:p-10 border border-border">
              ...
              <form onSubmit={handleRequestSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="description">Brief Description of Request *</Label>
                  <Textarea 
                    id="description" 
                    required 
                ...
                <p className="text-xs text-muted-foreground">
                  We aim to respond where appropriate. Due to the volume and nature of inquiries, 
                  we may not be able to reply to all submissions.
                </p>
              </form>
            </div>
          </motion.div>
      ...
      <Section variant="subtle" id="whistleblowing">
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mb-8">
            Pax Mongolica is committed to integrity, lawful conduct, and responsible governance. 
            This whistleblowing channel exists to report concerns regarding unethical, illegal, or 
            improper conduct related to Pax Mongolica or its associated activities. Reports may be 
            submitted confidentially and, where legally permissible, anonymously.
          </p>
          ...
          <div className="bg-card p-8 rounded-sm shadow-card">
            <form onSubmit={handleWhistleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="concernDescription">Description of Concern *</Label>
                <Textarea 
              ...
              <div className="space-y-2">
                <Label htmlFor="whistleContact">Your Contact Information (Optional)</Label>
                <Input 
                  id="whistleContact" 
              ...
              <div className="flex items-start gap-3">
                <Checkbox 
                  ...
                  onCheckedChange={(checked) => setWhistleConsent(checked as boolean)}
                />
                <Label htmlFor="whistleConsent" className="text-sm text-muted-foreground leading-relaxed cursor-pointer">
                  I confirm that this report is made in good faith and to the best of my knowledge.
                </Label>
              </div>
